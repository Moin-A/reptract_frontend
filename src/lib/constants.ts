export const BILL_IDS = { street1: "b-street1", street2: "b-street2", city: "b-city", state: "b-state", zip: "b-zip", country: "b-country" };
export const SHIP_IDS = { street1: "s-street1", street2: "s-street2", city: "s-city", state: "s-state", zip: "s-zip", country: "s-country" };
